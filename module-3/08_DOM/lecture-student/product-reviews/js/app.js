...
function setPageDescription() {
  ...
  // main.querySelector('.description').innerText = description; //another way to select it

  const descriptionElement = document.querySelector('.description'); //grab me the first thing with class description
...
function displayReviews() {
  ...
  reviews.forEach( (review) => {
    ...
    container.setAttribute('class','review'); //one way to set the class
...
function addRating(parent, numberOfStars) {
  ...
  for(let n = 0; n < numberOfStars; n++) {
    ...
    star.src = 'img/star.png' //shortcut you can use since src is a common attribute for images
    rating.appendChild(star); //append it as a child to this div class rating
  }
  parent.appendChild(rating); //append everything we created (div and img, etc) to our parent div container
}
...
function addReview(parent, review) {
  ...
  reviewElement.setAttribute('class', 'description');
