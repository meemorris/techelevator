...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        Card newCard= new Card("Jeck", Suit.SPADES); //this would be a compiler error if spades spelled like spodes, this is the benefit of enums, helps prevent errors from being compiled
