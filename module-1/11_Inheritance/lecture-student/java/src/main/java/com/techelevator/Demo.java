...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("High bid for the shoes is " + firstAuction.getHighBid().getBidAmount());
        System.out.println("Winning bidder is currently " + firstAuction.getHighBid().getBidder());
        ...
        BuyoutAction thirdAuction = new BuyoutAction("Time Machines (Lot of 12)", 450);
